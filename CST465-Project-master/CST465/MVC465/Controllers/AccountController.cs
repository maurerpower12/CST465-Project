...
namespace MVC465.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private ApplicationRoleManager _acctController;
        ...
        public AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager, ApplicationRoleManager accountController)
        {
            UserManager = userManager;
            SignInManager = signInManager;
            RoleManager = accountController;
        }
        ...
        public ApplicationRoleManager RoleManager
        {
            get
            {
                return _acctController ?? HttpContext.GetOwinContext().Get<ApplicationRoleManager>();
            }
            private set
            {
                _acctController = value;
            }
        }
